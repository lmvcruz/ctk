...
VideoGenerator::VideoGenerator(QObject* par) : QObject(par) {
    ...
    m_args = QStringList({"-r", "5", "-i", QDir::toNativeSeparators("out/%03d.png"), "-c:v",
                          "libx264", "-vf", "fps=25", "-pix_fmt", "yuv420p", "-y",
