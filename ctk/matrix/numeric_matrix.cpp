...
NumericMatrix::NumericMatrix(const NumericMatrix& that) {
    assert(that.data.type() == CV_64F &&
           that.data.channels() == 1);  // TODO: replace with exception ?
    type = that.type;
 ...
 * @param that  Reference to an existing NumericMatrix object
 * @return NumericMatrix resulting from the multiplication with the passed
 * matrix
 */
NumericMatrix NumericMatrix::operator*(const NumericMatrix& that) const {
 ...
 * @return NumericMatrix resulting from the addition of v to each element in the
 * matrix
 */
 ...
 * @param v double constant
 * @return  NumericMatrix resulting from the subtraction of v to each element in
 * the matrix
 */
NumericMatrix NumericMatrix::operator-(const double v) const {
    // TODO: use move constructor
 ...
 * @param v double constant
 * @return NumericMatrix resulting from the multiplication of v and each element
 * in the matrix
 */
NumericMatrix NumericMatrix::operator*(const double v) const {
    // TODO: use move constructor
...
/**
 * @brief NumericMatrix::operator *= Multiplication assignement operator with
 * const
 * @param v double constant
 */
void NumericMatrix::operator*=(const double v) {
 ...
 * @param v  double constant
 * @return NumericMatrix resulting from the diovision of each element in the
 * matrix by v
 */
NumericMatrix NumericMatrix::operator/(const double v) const {
 ...
 * @return The NumericMatrix resulting from the inversion of a given
 * NumericMatrix
 */
 ...
 * @return The NumericMatrix resulting from the transpose of a given
 * NumericMatrix
 */
